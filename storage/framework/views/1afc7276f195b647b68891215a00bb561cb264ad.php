		...
		<div id="loginBox">
			...
			<div id="loginTab" class="tabcontent">
				<div id="loginWithPanel">
					<p>Login with:</p>
					<a href="<?php echo e(route('provider.auth','facebook')); ?>"> <img id="facebookIcon" class="icon" src="icons/facebook_icon.png" alt="Facebook Icon"></a>
					<a href="<?php echo e(route('provider.auth','google')); ?>"> <img id="gmailIcon" class="icon" src="icons/gmail_icon.png" alt="GMail Icon"></a>

				</div>
				<form id="loginForm" action="<?php echo e(route('signin')); ?>" method="POST">
					<ul>
						<li>
							<div id="usernameLoginDiv">
								<img id="userIcon" class="icon" alt="User Icon" src="icons/user_icon.png">
								<input class="loginTextFields" type="text" name="username" placeholder="Username" value="<?php echo e(\Illuminate\Support\Facades\Request::old('username')); ?>">
							</div>
						</li>
						<li>
							<div id="passwordLoginDiv">
								<img id="passwordIcon" class="icon" alt="Password Icon" src="icons/password_icon.png">
								<input class="loginTextFields" type="password" name="password" placeholder="Password" value="<?php echo e(\Illuminate\Support\Facades\Request::old('password')); ?>">
