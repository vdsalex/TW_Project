...
<?php echo Html::script('js/header_loader.js'); ?>
...
<head>
    ...
    <iframe src="header.html" name="header" allowTransparency="true" scrolling="no" frameborder="0" >
    </iframe>
    <script>
        $(function ()
        {
           $("header").load("resources/views/header.html");
        });
    </script>
	<title>DiLy</title>
</head>
<body>
	...
	<img id="bg-img" src="../background/blue-gradient.png" alt="Blue Gradient">
    ...
    <script src="js/my_memories.js"></script>
